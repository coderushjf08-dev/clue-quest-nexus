...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border bg-card text-card-foreground shadow-card transition-all duration-200 hover:shadow-glow-purple hover:border-accent-purple/30",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-2xl font-gaming leading-none tracking-tight text-foreground",
      className
    )}
    {...props}
  />
